...
<?php else:
	...
	<div class="developers">
		<?php foreach ($developers as $developer): ?>
			<div class="developer">
				<div class="avatar"><img src="<?php echo $developer['avatar_url']; ?>" alt="<?= t('credits.avatar_of', ['name' => $developer['login']]) ?>"></div>
...
<p>
	...
	<br><a href="https://otland.net/members/evan.40401/">Evan</a>, <a href="https://otland.net/members/gremlee.12075/">Gremlee</a> - <?= t('credits.thanks_evan_gremlee') ?>
	<br><a href="https://otland.net/members/att3.98289/">ATT3</a> - <?= t('credits.thanks_att3') ?>
