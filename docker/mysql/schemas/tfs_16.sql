-- The Forgotten Server (TFS) 1.6 database schema.
-- Source: https://github.com/otland/forgottenserver/blob/v1.6/schema.sql
-- License: GPL-2.0. Covers ZnoteX's TFS_16 engine choice.
