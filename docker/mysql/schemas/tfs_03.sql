-- OTX Server database schema.
-- Source: https://github.com/mattyx14/otxserver/blob/main/schema.sql
-- License: GPL-2.0. Covers ZnoteX's TFS_03 engine choice ("TFS 0.3.6+ / 0.4 / OTX").
