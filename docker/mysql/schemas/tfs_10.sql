-- The Forgotten Server (TFS) 1.1 database schema.
-- Source: https://github.com/otland/forgottenserver/blob/v1.1/schema.sql
-- License: GPL-2.0. Covers ZnoteX's TFS_10 engine choice ("TFS 1.1 - 1.4.2").
