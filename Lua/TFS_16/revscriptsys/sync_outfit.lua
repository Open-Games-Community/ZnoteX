...
-- so characterprofile.php can show them. TFS 1.x revscriptsys.
--
-- looktype lists below are the complete Female / Male outfit sets from the
-- current opentibiabr/canary data/XML/outfits.xml. Trim them to your client's
-- outfits.xml, or regenerate from that file if you add custom outfits.
