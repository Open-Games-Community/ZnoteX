...
require_once 'function/backups.php';
require_once 'function/health.php';
require_once 'function/login_guard.php';
...
require_once 'function/serverdata_overrides.php';
require_once 'function/plugins.php';
require_once 'function/scheduler.php';
